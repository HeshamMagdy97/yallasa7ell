...
class ApartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post apartments_url, params: { apartment: { paths: @apartment.paths, rooms: @apartment.rooms, user_id: @apartment.user_id } }
    end
  ...
  test "should update apartment" do
    patch apartment_url(@apartment), params: { apartment: { paths: @apartment.paths, rooms: @apartment.rooms, user_id: @apartment.user_id } }
